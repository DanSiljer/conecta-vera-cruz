(function () {
  ...
  const board = document.getElementById("jaburuPuzzleBoard");
  const tray = document.getElementById("jaburuPuzzleTray");
  if (!board || !tray) return;

  const difficulty = document.getElementById("jaburuPuzzleDifficulty");
  const startButton = document.getElementById("jaburuPuzzleStart");
  const showButton = document.getElementById("jaburuPuzzleShow");
  const resetButton = document.getElementById("jaburuPuzzleReset");
  const movesOutput = document.getElementById("jaburuPuzzleMoves");
  const timeOutput = document.getElementById("jaburuPuzzleTime");
  const placedOutput = document.getElementById("jaburuPuzzlePlaced");
  const totalOutput = document.getElementById("jaburuPuzzleTotal");
  const messageOutput = document.getElementById("jaburuPuzzleMessage");
  ...
  function createPieceSvg(index, ghost) {
    ...
    svg.classList.add("jaburu-puzzle__piece-svg");
    ...
    outline.classList.add(ghost ? "jaburu-puzzle__ghost-outline" : "jaburu-puzzle__piece-outline");
  ...
  function createPiece(index) {
    ...
    piece.type = "button";
    piece.className = "jaburu-puzzle__piece";
  ...
  function createSlot(index) {
    ...
    const col = index % state.size;
    slot.type = "button";
    slot.className = "jaburu-puzzle__slot";
  ...
  function saveProgress() {
    ...
    results.unshift({
      ...
      activity: "Quebra-cabeça da Capela do Jaburu · " + difficultyName,
  ...
  function finishGame() {
    ...
    messageOutput.innerHTML = "<strong>Quebra-cabeça concluído!</strong> Você montou a Capela do Jaburu em " + state.moves + " movimentos e " + formatTime(state.seconds) + ". O resultado foi salvo em Meu progresso.";
  ...
  function resetGame() {
    ...
    board.classList.remove("is-complete", "is-hinting");
    buildBoard();
    tray.innerHTML = '<div class="jaburu-puzzle__tray-empty"><span>🧩</span><strong>As peças aparecerão aqui</strong><p>Escolha o nível e clique em “Começar jogo”.</p></div>';
    updateStats();
  ...
  preload.addEventListener("error", function () {
    resetGame();
    messageOutput.textContent = "A imagem do quebra-cabeça não foi encontrada. Confira assets/img/jogos/capela-velasquez-jaburu.jpg.";
  });
