(function () {
  ...
  const board = document.getElementById("capelaPuzzleBoard");
  const tray = document.getElementById("capelaPuzzleTray");
  if (!board || !tray) return;

  const difficulty = document.getElementById("capelaPuzzleDifficulty");
  const startButton = document.getElementById("capelaPuzzleStart");
  const showButton = document.getElementById("capelaPuzzleShow");
  const resetButton = document.getElementById("capelaPuzzleReset");
  const movesOutput = document.getElementById("capelaPuzzleMoves");
  const timeOutput = document.getElementById("capelaPuzzleTime");
  const placedOutput = document.getElementById("capelaPuzzlePlaced");
  const totalOutput = document.getElementById("capelaPuzzleTotal");
  ...
  function createPieceSvg(index, ghost) {
    ...
    outline.classList.add(ghost ? "capela-puzzle__ghost-outline" : "capela-puzzle__piece-outline");
  ...
  function createPiece(index) {
    ...
    piece.type = "button";
    piece.className = "capela-puzzle__piece";
  ...
  function createSlot(index) {
    ...
    const col = index % state.size;
    slot.type = "button";
    slot.className = "capela-puzzle__slot";
  ...
  function saveProgress() {
    ...
    results.unshift({
      ...
      activity: "Quebra-cabeça da Igreja Nosso Senhor da Vera Cruz · " + difficultyName,
  ...
  function finishGame() {
    ...
    messageOutput.innerHTML = "<strong>Quebra-cabeça concluído!</strong> Você montou a Igreja Nosso Senhor da Vera Cruz em " + state.moves + " movimentos e " + formatTime(state.seconds) + ". O resultado foi salvo em Meu progresso.";
  ...
  preload.addEventListener("error", function () {
    resetGame();
    messageOutput.textContent = "A imagem do quebra-cabeça não foi encontrada. Confira assets/img/jogos/igreja-nosso-senhor-da-vera-cruz.png.";
  });
