(function () {
  ...
  const board = document.getElementById("bomJesusPuzzleBoard");
  const tray = document.getElementById("bomJesusPuzzleTray");
  if (!board || !tray) return;

  const difficulty = document.getElementById("bomJesusPuzzleDifficulty");
  const startButton = document.getElementById("bomJesusPuzzleStart");
  const showButton = document.getElementById("bomJesusPuzzleShow");
  const resetButton = document.getElementById("bomJesusPuzzleReset");
  const movesOutput = document.getElementById("bomJesusPuzzleMoves");
  const timeOutput = document.getElementById("bomJesusPuzzleTime");
  const placedOutput = document.getElementById("bomJesusPuzzlePlaced");
  const totalOutput = document.getElementById("bomJesusPuzzleTotal");
  const messageOutput = document.getElementById("bomJesusPuzzleMessage");
  ...
  function createPieceSvg(index, ghost) {
    ...
    svg.classList.add("bomjesus-puzzle__piece-svg");
    ...
    outline.classList.add(ghost ? "bomjesus-puzzle__ghost-outline" : "bomjesus-puzzle__piece-outline");
  ...
  function createPiece(index) {
    ...
    piece.type = "button";
    piece.className = "bomjesus-puzzle__piece";
  ...
  function createSlot(index) {
    ...
    const col = index % state.size;
    slot.type = "button";
    slot.className = "bomjesus-puzzle__slot";
  ...
  function saveProgress() {
    ...
    results.unshift({
      ...
      activity: "Quebra-cabeça do Bom Jesus da Gamboa · " + difficultyName,
  ...
  function resetGame() {
    ...
    buildBoard();
    fitPuzzleToScreen();
    tray.innerHTML = '<div class="bomjesus-puzzle__tray-empty"><span>🧩</span><strong>As peças aparecerão aqui</strong><p>Escolha o nível e clique em “Começar jogo”.</p></div>';
    updateStats();
  ...
  preload.addEventListener("error", function () {
    resetGame();
    messageOutput.textContent = "A imagem do quebra-cabeça não foi encontrada. Confira assets/img/jogos/bom-jesus-gamboa.jpg.";
  });
